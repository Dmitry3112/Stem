...
public class Main {
    public static void main(String[] args) {
        List<String> names = Arrays.asList("Conor", "Tommy", "Arthur", "George", "Samuel", "John");
        List<String> families = Arrays.asList("McGregor", "Shelby", " Shelby", "Adamson", "Pupkin", "Davies", "Shelby");
